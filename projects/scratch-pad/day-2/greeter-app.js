...
//Using an if, else if, and else conditonal statements to create a greater app that prints pharases according to the given time 
//Using the comparison operators 
//Using one of the logical operators the amber sand to be inclusive for both comparisons 
//Using console.log to print greeting pharses to the screen
